...
function Packages() {
  ...
  return (
    <div className="w-screen bg-base-300 flex-col flex items-center justify-center py-10">
        ...
        <div className="card bg-base-100 w-80 py-10 flex items-center justify-center flex-col shadow-xl">
          <div className="px-2 w-4/5 flex items-start justify-center flex-col">
            ...
            <div className="card-actions mt-5 w-full ">
              <button className="btn  hover:btn-primary w-full mt-5" onClick={handleClick}>
                Get My Card
              </button>
            </div>
          </div>

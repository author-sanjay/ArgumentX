...
function UploadARScreen({ orderId = "#111", customerName = "James", orderDate = moment().format("Do MMMM YY"), status = "Processing" }) {
  ...
  return (
    <div className="w-screen bg-base-200 flex-col flex items-center h-screen overflow-hidden  select-none" data-theme={theme} >
      <DashBoardNav admin={true} />
      <div className="w-2/3 h-full items-center justify-center flex  flex-col px-8 py-6 ">
        {/* Order Details Section */}
        <div className="mb-6 bg-base-100 px-10 py-5 rounded-lg w-full shadow-lg">
          ...
          <div className="flex justify-between items-center">
            ...
            <div>
              <span
                className={`py-1 px-3 rounded-lg text-sm ${status === "Pending AR Upload"
        ...
        <div className="mb-6 w-full  bg-base-100 px-10 py-5 rounded-lg shadow-lg">
